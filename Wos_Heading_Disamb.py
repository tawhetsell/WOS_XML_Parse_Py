# the following script iterates throught the csv matrixes and disambiguates the country names
...
base_output_directory = 'C:/Users/twhetsell3/OneDrive - Georgia Institute of Technology/Priority 1/academic_freedom/WOS_HEADING_CAT_PY/PY_FILES'

# Define categories based on your updated file naming convention
categories = [
    'arts_humanities',
    'science_technology',
    'socialsciences'
...
def process_and_save_csv(input_file, output_file):
    ...
    df_grouped.to_csv(output_file, index=True)


for category in categories:
    for year in range(1993, 2023):  # Adjust the range as necessary
        ...
        if os.path.exists(input_path):
            ...
            print(f'Successfully saved disambiguated file: {output_filename}')
        else:
            print(f'File does not exist: {input_filename}, skipping...')
